...
- 🐛 Fixed Attachments `image` card style.[#751](https://github.com/ant-design/x/pull/736) by [@wzc520pyfm](https://github.com/wzc520pyfm) 
- 🐛 Fixed ThoughtChain controlled issue.[#752](https://github.com/ant-design/x/pull/736) by [@Youzi2233](https://github.com/kimteayon) 
- XRequest
  ...
  - 🆕 Add an example of model integration. [#725](https://github.com/ant-design/x/pull/726) by [@kimteayon](https://github.com/kimteayon) 
...
- useXAgent
  ...
  - 🆕 RequestFn has added a `transformStream` transformation function for processing stream data.[#725](https://github.com/ant-design/x/pull/726) by [@kimteayon](https://github.com/kimteayon) 
  ...
  - 🐛 Fix the issue of incorrect callback types for RequestFn ` onSuccess ` and update the corresponding demo. [#725](https://github.com/ant-design/x/pull/726) by [@kimteayon](https://github.com/kimteayon) 
  - 🆕 Add model access, Custom RequestParams,and customize `XRequestOptions`demos. [#725](https://github.com/ant-design/x/pull/726) by [@kimteayon](https://github.com/kimteayon) 提交、[#711](https://github.com/ant-design/x/pull/711) by [@kimteayon](https://github.com/kimteayon) 
- useXChat
  - 🆕 XChatConfig adds input and output generic types.[#725](https://github.com/ant-design/x/pull/726) by [@kimteayon](https://github.com/kimteayon) 
