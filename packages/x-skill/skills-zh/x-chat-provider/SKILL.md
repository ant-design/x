...
> import { XMarkdown } from '@ant-design/x-markdown'; // Markdown 渲染层
> ```
...
| **🖼️ 渲染者** | **x-markdown** | Markdown 内容 | 渲染流式 Markdown 与富内容区块 | 助手回复展示 |
...
4. **x-markdown** → 渲染 Markdown 回复、自定义标签和流式富内容
