...
| rawTextComponents | Treat children of HTML tags matched by `components` as raw text, without parsing Markdown or HTML inside. Pass an array to target specific tags | `boolean \| string[]` | `false` |
