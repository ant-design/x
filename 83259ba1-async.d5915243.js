(("undefined"!=typeof globalThis?globalThis:self)["makoChunk_@ant-design/x"]=("undefined"!=typeof globalThis?globalThis:self)["makoChunk_@ant-design/x"]||[]).push([["83259ba1"],{"150e5baa":function(e,t,n){"use strict";n.d(t,"__esModule",{value:!0}),n.e(t,{default:function(){return d;},useStyle:function(){return s;}});var i=n("a4446a09"),a=n("735a2091"),o=n("78539509");let s=(0,n("65bfd38d").createStyles)(({css:e})=>({sender:e`
    ...
    `}));var d=e=>{let{styles:t}=s();return(0,i.jsx)(a.Sender,{className:t.sender,actions:()=>(0,i.jsx)(o.Button,{type:"text",style:{padding:0},onClick:()=>{var t;return null==e?void 0:null===(t=e.onSubmit)||void 0===t?void 0:t.call(e,e.value);},icon:(0,i.jsx)("img",{alt:"send",loading:"lazy",src:"https://mdn.alipayobjects.com/huamei_iwk9zp/afts/img/A*4e5sTY9lU3sAAAAAAAAAAAAADgCCAQ/original"})}),...e});};},"167301b7":function(e,t,n){"use strict";n.d(t,"__esModule",{value:!0}),n.d(t,"default",{enumerable:!0,get:function(){return u;}});var i=n("777fffbe"),a=n("a4446a09"),o=n("65bfd38d"),s=i._(n("70ad0bd7")),d=i._(n("643f424f")),r=i._(n("c99671d4")),l=i._(n("71e88319")),c=i._(n("072c34e7")),f=i._(n("f2d49c9f")),p=i._(n("b9277cff"));let g=(0,o.createStyles)(({token:e,css:t})=>({section:t`
    ...
    `}));var u=()=>{let{styles:e}=g();return(0,a.jsxs)("main",{children:[(0,a.jsx)(f.default,{}),(0,a.jsx)("section",{className:e.section,children:(0,a.jsx)(r.default,{})}),(0,a.jsx)("section",{className:(0,s.default)(e.section,e.container),children:(0,a.jsx)(c.default,{})}),(0,a.jsxs)("section",{className:(0,s.default)(e.section,e.container),children:[(0,a.jsx)(p.default,{}),(0,a.jsx)(d.default,{})]}),(0,a.jsx)("section",{className:(0,s.default)(e.section,e.framework,e.container),children:(0,a.jsx)(l.default,{})})]});};},"4dda42ac":function(e,t,n){"use strict";n.d(t,"__esModule",{value:!0}),n.d(t,"default",{enumerable:!0,get:function(){return r;}});var i=n("777fffbe"),a=n("a4446a09"),o=n("65bfd38d"),s=i._(n("70ad0bd7"));let d=(0,o.createStyles)(({token:e,css:t})=>({container:t`
      width: 100%;
      margin: 0 auto;
    ...
    `,desc:t`
      ...
      text-align: center;
      padding-bottom: ${e.padding}px;
    `}));var r=e=>{let{styles:t}=d();return(0,a.jsxs)("div",{className:(0,s.default)(t.container,e.className),style:e.style,onClick:e.onClick,children:[e.title&&(0,a.jsx)("h2",{className:t.title,children:e.title}),e.desc&&(0,a.jsx)("p",{className:t.desc,children:e.desc}),e.children]});};},"83259ba1":function(e,t,n){"use strict";n.d(t,"__esModule",{value:!0}),n.d(t,"default",{enumerable:!0,get:function(){return i;}});var i=n("777fffbe")._(n("167301b7")).default;},b95e707a:function(e,t,n){"use strict";n.d(t,"__esModule",{value:!0}),n.d(t,"default",{enumerable:!0,get:function(){return l;}});var i=n("777fffbe"),a=n("a4446a09"),o=n("65bfd38d"),s=i._(n("4dda42ac")),d=i._(n("c1587eef"));let r=(0,o.createStyles)(({token:e,css:t})=>({container:t`
      overflow: hidden;
    `,content:t`
      display: grid;
      width: 100%;
    ...
    `}));var l=e=>{var t,n;let{styles:i}=r();return(0,a.jsx)(s.default,{className:i.container,title:e.title,desc:e.desc,children:(0,a.jsx)("div",{className:i.content,style:{gridTemplateColumns:`repeat(${e.column||(null===(t=e.items)||void 0===t?void 0:t.length)}, 1fr)`},children:null===(n=e.items)||void 0===n?void 0:n.map(t=>(0,a.jsxs)("div",{className:i.item,style:e.cardStyle,onClick:t.onClick,children:[t.header&&(0,a.jsx)("div",{className:i.item_header,children:(0,a.jsx)(d.default,{children:t.header})}),(0,a.jsxs)("div",{className:i.item_content,children:[t.icon&&(0,a.jsx)("img",{className:i.item_icon,src:t.icon,alt:t.icon}),(0,a.jsxs)("div",{children:[(0,a.jsxs)("h3",{className:i.item_title,children:[t.title,t.tag&&(0,a.jsx)("span",{className:i.item_tag,style:{background:`linear-gradient(127deg, ${t.startColor||"#fff"} 23%, ${t.endColor||"#fff"} 100%)`,WebkitBackgroundClip:"text"},children:t.tag})]}),(0,a.jsx)("p",{className:i.item_desc,children:t.desc})]})]})]},`${t.title}`))})});};},c1587eef:function(e,t,n){"use strict";n.d(t,"__esModule",{value:!0}),n.e(t,{DESIGN_STAGE_COLOR:function(){return r;},LOCALES:function(){return d;},default:function(){return c;},useCustomizationBgStyle:function(){return s;}});var i=n("a4446a09"),a=n("735a2091"),o=n("65bfd38d");let s=(0,o.createStyles)(({token:e,css:t})=>({background:t`
    ...
    `,suggestion:t`
      border-radius: ${20}px;
      position: relative;
    `}));var c=e=>{let{styles:t}=l();return(0,i.jsx)(a.XProvider,{conversations:{className:t.conversations},sender:{className:t.sender},prompts:{className:t.prompts},welcome:{className:t.welcome},suggestion:{className:t.suggestion},children:e.children});};}}]);
//# sourceMappingURL=83259ba1-async.d5915243.js.map