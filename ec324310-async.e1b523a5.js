...
`;var l=()=>{let{colorBgElevated:e}=(0,i.useTheme)(),t=(0,r.useRef)({colorBgElevated:e}),o=(e,t)=>{(0,n.updateCSS)(`
    * {
    ...
    color: ${e.colorText} !important;
    font-weight: 500;
  `}));var f=e=>{var t,o;let{isZhCN:i,isMobile:r,isMini:f,isRTL:h,className:x}=e,{styles:b}=g(),[w]=(0,s.default)(u),{search:$,pathname:v}=(0,l.useLocation)(),[k,y]=d.default.useState(),S=(null===(o=(0,l.useFullSidebarData)()["/docs/blog"])||void 0===o?void 0:null===(t=o[0])||void 0===t?void 0:t.children)||[],_=d.default.useMemo(()=>{let e=[...m];return S.length&&e.push({path:S.sort((e,t)=>{var o,i;return(null===(o=e.frontmatter)||void 0===o?void 0:o.date)>(null===(i=t.frontmatter)||void 0===i?void 0:i.date)?-1:1;})[0].link,basePath:"/docs/blog",key:"blog"}),e;},[S.length]);d.default.useEffect(()=>{if(!_.length||!v)return;let e=_.findIndex(e=>v.includes(e.basePath));-1===e?y(void 0):y(_[e].key);},[v,_.length]);let j=e=>()=>y(e);return(0,n.jsx)("nav",{className:(0,a.default)(b.nav,r||f?b.mobile:b.pc,f&&b.mini,!r&&!f&&h&&b.pc_rtl,x),children:_.map(e=>(0,n.jsx)(c.default,{to:(0,p.getLocalizedPathname)(e.path,i,$),onClick:j(e.key),className:k===e.key?b.item_active:"",children:w[e.key]},e.key))});};},"6dbf8ae0":function(e,t,o){"use strict";o.d(t,"__esModule",{value:!0}),o.d(t,"default",{enumerable:!0,get:function(){return l;}});var i=o("8090cfc0"),n=o("8997291d"),r=o("0ba2ace3");let a={1:"#fff",2:"#fafafa",3:"#f5f5f5",4:"#f0f0f0",5:"#d9d9d9",6:"#bfbfbf",7:"#8c8c8c",8:"#595959",9:"#434343",10:"#262626",11:"#1f1f1f",12:"#141414",13:"#000"};var l=()=>{let e=(0,r.useTheme)(),t=(o,i=1)=>i<=10?`
.palette-${o}-${i} {
  background: ${e[`${o}-${i}`]};
}
${t(o,i+1)}
...
//# sourceMappingURL=ec324310-async.e1b523a5.js.map