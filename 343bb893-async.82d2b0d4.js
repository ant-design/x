...
</html>`};async loadFileContent(e){await new Promise(e=>setTimeout(e,500));let t=this.mockFiles[e];if(t)return t;throw Error(`File ${e} does not exist`);}}var l=()=>(0,r.jsx)("div",{style:{padding:24,height:500},children:(0,r.jsx)(a.default,{treeData:o,previewTitle:({path:e})=>e.join("/"),fileContentService:new i,defaultSelectedFile:["src","App.js"]})});},"8f49b0cf":function(e,t,s){"use strict";s.d(t,"__esModule",{value:!0}),s.d(t,"default",{enumerable:!0,get:function(){return p;}});var n=s("777fffbe"),r=s("8090cfc0");s("23e14296");var a=s("2020273b"),o=n._(s("0ef2e5e5")),i=n._(s("86cb85cd")),l=n._(s("fd409399")),c=n._(s("17027f80")),d=s("3e6b097d");let u=[{title:"my-project",path:"my-project",children:[{title:"src",path:"src",children:[{title:"components",path:"components",children:[{title:"App.tsx",path:"App.tsx",content:'import React from "react";\n\nexport default function App() {\n  return <div>Hello World</div>;\n}'},{title:"Button.tsx",path:"Button.tsx",content:"export const Button = () => <button>Click</button>;"}]},{title:"index.ts",path:"index.ts",content:'export { default as App } from "./components/App";'}]},{title:"public",path:"public",children:[{title:"index.html",path:"index.html",content:"<!DOCTYPE html><html><body></body></html>"}]},{title:"package.json",path:"package.json",content:'{\n  "name": "my-project",\n  "version": "1.0.0"\n}',contextMenu:[{key:"edit",label:"Edit JSON",icon:(0,r.jsx)(a.EditOutlined,{})},{key:"copy",label:"Copy Path",icon:(0,r.jsx)(a.CopyOutlined,{})},{type:"divider"},{key:"info",label:"Package Info",icon:(0,r.jsx)(a.InfoCircleOutlined,{})}]},{title:"README.md",path:"README.md",content:"# My Project\n\nThis is a sample project.",contextMenu:[{key:"edit",label:"Edit README",icon:(0,r.jsx)(a.EditOutlined,{})},{key:"preview",label:"Preview Markdown",icon:(0,r.jsx)(a.InfoCircleOutlined,{})}]}]}];var p=()=>{let e=(0,d.useRef)(null),[t,s]=(0,d.useState)(u),[n,p]=(0,d.useState)(""),m=(0,d.useRef)(1),g=e=>{let t=`${e}${m.current}`;return m.current+=1,t;},h=e=>e.split("/").filter(Boolean),f=(e,t)=>{let s=!!e.children&&e.children.length>0,n=[{key:"newFile",label:"New File",icon:(0,r.jsx)(a.FileAddOutlined,{})},{key:"newFolder",label:"New Folder",icon:(0,r.jsx)(a.FolderAddOutlined,{})},{type:"divider"},{key:"copyPath",label:"Copy Path",icon:(0,r.jsx)(a.CopyOutlined,{})},{key:"copyName",label:"Copy Name",icon:(0,r.jsx)(a.CopyOutlined,{})},{type:"divider"},{key:"rename",label:"Rename",icon:(0,r.jsx)(a.EditOutlined,{})},{key:"refresh",label:"Refresh",icon:(0,r.jsx)(a.ReloadOutlined,{})},{type:"divider"},{key:"delete",label:"Delete",icon:(0,r.jsx)(a.DeleteOutlined,{}),danger:!0}],o=[{key:"open",label:"Open File",icon:(0,r.jsx)(a.EditOutlined,{})},{key:"copyPath",label:"Copy Path",icon:(0,r.jsx)(a.CopyOutlined,{})},{key:"copyName",label:"Copy Name",icon:(0,r.jsx)(a.CopyOutlined,{})},{type:"divider"},{key:"rename",label:"Rename",icon:(0,r.jsx)(a.EditOutlined,{})},{type:"divider"},{key:"delete",label:"Delete",icon:(0,r.jsx)(a.DeleteOutlined,{}),danger:!0}];return s?n:o;},v=(0,d.useCallback)((t,n)=>{var r,a;let o=h(n),l=e.current;switch(t){case"rename":{let e=g("renamed_");s(t=>(null==l?void 0:l.updateNode(o,{title:e,path:e}))??t),i.default.success(`Renamed to "${e}"`),p(`Rename: ${n} \u{2192} ${e}`);break;}case"delete":s(e=>(null==l?void 0:l.deleteNode(o))??e),i.default.success(`Deleted "${n}"`),p(`Delete: ${n}`);break;case"newFile":{let e=`${g("new_file")}.ts`;s(t=>(null==l?void 0:l.addNode(o,{title:e,path:e,content:`// ${e}`}))??t),i.default.success(`Created file "${e}"`),p(`New File: ${e} under ${n}`);break;}case"newFolder":{let e=g("new_folder");s(t=>(null==l?void 0:l.addNode(o,{title:e,path:e,children:[]}))??t),i.default.success(`Created folder "${e}"`),p(`New Folder: ${e} under ${n}`);break;}case"copyPath":null===(r=navigator.clipboard)||void 0===r||r.writeText(n),i.default.success(`Path copied: ${n}`),p(`Copy Path: ${n}`);break;case"copyName":{let e=o[o.length-1];null===(a=navigator.clipboard)||void 0===a||a.writeText(e),i.default.success(`Name copied: ${e}`),p(`Copy Name: ${e}`);break;}case"refresh":i.default.info("Refreshed"),p(`Refresh: ${n}`);break;case"open":case"edit":case"info":case"preview":i.default.info(`${t}: ${n}`),p(`${t}: ${n}`);}},[t]),y=(0,d.useCallback)((e,t)=>{let s="function"==typeof f?f(e,t):f;return s?s.map(e=>e&&"key"in e?{...e,onClick:()=>v(e.key,t)}:e):s;},[v]);return(0,r.jsxs)("div",{style:{padding:24,height:500},children:[(0,r.jsxs)(l.default,{style:{marginBottom:12,display:"flex",flexWrap:"wrap"},children:[(0,r.jsx)(c.default,{color:"blue",children:"Right-click any file or folder to see context menu"}),n&&(0,r.jsx)(c.default,{color:"green",children:n})]}),(0,r.jsx)(o.default,{ref:e,treeData:t,defaultSelectedFile:["my-project","src","components","App.tsx"],contextMenu:y,onRightClick:({node:e})=>{let t="string"==typeof e.title?e.title:e.key;p(`Right-clicked: ${t}`);}})]});};},"9d56fe92":function(e,t,s){"use strict";s.d(t,"__esModule",{value:!0}),s.d(t,"default",{enumerable:!0,get:function(){return p;}});var n=s("777fffbe"),r=s("8090cfc0");s("d19cd46f");var a=n._(s("0ef2e5e5")),o=n._(s("cca35c65")),i=n._(s("fd409399")),l=n._(s("17027f80")),c=s("3e6b097d");let d=[{title:"project-root",path:"project-root",children:[{title:"src",path:"src",children:[{title:"components",path:"components",children:[{title:"Header.tsx",path:"Header.tsx",content:"Header component implementation..."},{title:"Footer.tsx",path:"Footer.tsx",content:"Footer component implementation..."},{title:"Sidebar.tsx",path:"Sidebar.tsx",content:"Sidebar component implementation..."}]},{title:"pages",path:"pages",children:[{title:"Home.tsx",path:"Home.tsx",content:"Home page component..."},{title:"About.tsx",path:"About.tsx",content:"About page component..."},{title:"Contact.tsx",path:"Contact.tsx",content:"Contact page component..."}]},{title:"utils",path:"utils",children:[{title:"helpers.ts",path:"helpers.ts",content:"Helper functions..."},{title:"constants.ts",path:"constants.ts",content:"Application constants..."}]}]},{title:"public",path:"public",children:[{title:"index.html",path:"index.html",content:"<!DOCTYPE html>..."},{title:"favicon.ico",path:"favicon.ico",content:"Favicon file..."}]},{title:"package.json",path:"package.json",content:'{\n  "name": "my-project"\n}'},{title:"README.md",path:"README.md",content:"# Project Documentation..."}]}],u=(e,t)=>t?e.reduce((e,s)=>{let n=s.path.toLowerCase().includes(t.toLowerCase()),r=[];return s.children&&(r=u(s.children,t)),(n||r.length>0)&&e.push({...s,children:r.length>0?r:s.children}),e;},[]):e;var p=()=>{let[e,t]=(0,c.useState)(""),[s,n]=(0,c.useState)(["project-root","src","components","Header.tsx"]),p=(0,c.useMemo)(()=>u(d,e),[e]);return(0,r.jsxs)("div",{style:{padding:24,height:600},children:[(0,r.jsxs)(i.default,{vertical:!0,style:{width:"100%",marginBottom:16},children:[(0,r.jsx)(o.default.Search,{placeholder:"Search files or folders...",value:e,onChange:e=>t(e.target.value),allowClear:!0}),(0,r.jsxs)(i.default,{children:[(0,r.jsxs)(l.default,{color:"blue",children:["Total Files: ",m(d)]}),(0,r.jsxs)(l.default,{color:"green",children:["Matching Results: ",m(p)]})]})]}),(0,r.jsx)(a.default,{treeData:p,selectedFile:s,onSelectedFileChange:({path:e})=>n(e),directoryTitle:(0,r.jsxs)("div",{style:{whiteSpace:"nowrap",padding:12,borderBottom:"1px solid #f0f0f0"},children:[(0,r.jsx)("strong",{children:"Project File Browser"}),e&&(0,r.jsxs)("div",{style:{fontSize:12,color:"#666",marginTop:4},children:['Search: "',e,'"']})]})})]});};function m(e){return e.reduce((e,t)=>t.children?e+m(t.children):e+1,0);}},bcf6e743:function(e,t,s){"use strict";s.d(t,"__esModule",{value:!0}),s.d(t,"default",{enumerable:!0,get:function(){return u;}});var n=s("777fffbe"),r=s("8090cfc0");s("f21b0dd9");var a=n._(s("0ef2e5e5")),o=n._(s("bf2579c8")),i=n._(s("d78812de")),l=n._(s("fd409399")),c=s("3e6b097d");let d=[{title:"x-chat-provider",path:"x-chat-provider",children:[{title:"SKILL.md",path:"SKILL.md",content:`---
