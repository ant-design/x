...
| content | 聊天内容 | string | - |  |
| footer | 底部内容 | React.ReactNode \| (info: {content: [BubbleContentType](https://github.com/ant-design/x/blob/d3232c925a0dc61ad763c6664e16f07323ebca4a/components/bubble/interface.ts#L21)})) => React.ReactNode | - |  |
| header | 头部内容 | React.ReactNode \| (info: {content: [BubbleContentType](https://github.com/ant-design/x/blob/d3232c925a0dc61ad763c6664e16f07323ebca4a/components/bubble/interface.ts#L21)}) => React.ReactNode | - |  |
