...
<code src="./demo/semantic-list-custom.tsx">语义化自定义列表内容</code>
<code src="./demo/list-custom.tsx">自定义列表内容</code>

<code src="./demo/debug.tsx" debug>debug</code> <code src="./demo/debug-list.tsx" debug>debug list</code>
...
| footer | 底部内容 | React.ReactNode \| (content: [BubbleContentType](https://github.com/ant-design/x/blob/d3232c925a0dc61ad763c6664e16f07323ebca4a/components/bubble/interface.ts#L21),info:{content: ContentType, key: string \| number } ) => React.ReactNode | - |  |
