...
*/
  .code-box {
    ...
    `};});var h=()=>{let e=(0,c.useSidebarData)(),{isMobile:t,theme:n,alertVisible:i}=p.default.use(m.default),{styles:h}=g({alertVisible:i}),{pathname:x}=(0,u.default)(),[b,w]=(0,f.default)(),$=n.includes("dark"),{colorBgContainer:v}=(0,s.useTheme)(),k=(0,o.jsx)(r.default,{theme:{components:{Menu:{itemBg:v,darkItemBg:v}}},children:(0,o.jsx)(d.default,{items:b,inlineIndent:30,className:h.asideContainer,mode:"inline",theme:$?"dark":"light",selectedKeys:[w],defaultOpenKeys:null==e?void 0:e.map(({title:e})=>e).filter(Boolean)},x)});return t?(0,o.jsx)(a.default,{children:k},"Mobile-menu"):(0,o.jsx)(l.default,{xxl:4,xl:5,lg:6,md:6,sm:24,xs:24,className:h.mainMenu,children:k});};},fa5f6340:function(e,t,n){"use strict";n.d(t,"__esModule",{value:!0}),n.d(t,"default",{enumerable:!0,get:function(){return a;}});var i=n("8090cfc0"),o=n("8997291d"),r=n("2bb52879"),a=()=>{let e=(0,r.useTheme)(),{antCls:t,iconCls:n}=e;return(0,i.jsx)(o.Global,{styles:(0,o.css)`
      ...
      `});};},fefdb32c:function(e,t,n){"use strict";n.d(t,"__esModule",{value:!0}),n.d(t,"default",{enumerable:!0,get:function(){return f;}});var i=n("777fffbe"),o=n("852bbaa9"),r=n("8090cfc0"),a=n("2020273b"),l=n("2bb52879"),d=n("46c8afcf"),s=n("add35e7f"),c=i._(n("a8ae155a")),p=o._(n("3e6b097d"));let u=(0,l.createStyles)(({token:e,css:t})=>({container:t`
    display: flex;
    align-items: center;
  ...
  `}));var f=({isMobile:e})=>{let{styles:t}=u(),n=p.useRef(null),i=p.useRef(null),[o,l]=p.useState(!1),{pathname:f}=(0,s.useLocation)();return(p.useEffect(()=>{l(!1);},[f]),p.useEffect(()=>{o&&!e&&requestAnimationFrame(()=>{var e;let t=null===(e=n.current)||void 0===e?void 0:e.querySelector("input");null==t||t.focus();});},[o,e]),p.useEffect(()=>()=>{i.current&&clearTimeout(i.current);},[]),e)?null:(0,r.jsx)(r.Fragment,{children:(0,r.jsxs)("div",{className:t.container,children:[(0,r.jsx)("button",{type:"button","aria-label":"Search","aria-hidden":o,className:(0,d.clsx)(t.iconBtn,o?t.iconBtnHidden:t.iconBtnVisible),onClick:()=>l(!0),children:(0,r.jsx)(a.SearchOutlined,{})}),(0,r.jsx)("div",{ref:n,"aria-hidden":!o,className:(0,d.clsx)(t.searchWrapper,o&&t.searchWrapperExpanded),onBlur:()=>{i.current=window.setTimeout(()=>{n.current&&!n.current.contains(document.activeElement)&&l(!1);},150);},children:(0,r.jsx)(c.default,{})})]})});};},ff4be71a:function(e,t,n){"use strict";n.d(t,"__esModule",{value:!0}),n.d(t,"default",{enumerable:!0,get:function(){return u;}});var i=n("777fffbe"),o=n("8090cfc0"),r=n("2bb52879"),a=i._(n("3e6b097d")),l=i._(n("8ff5a1c9")),d=i._(n("033c7941")),s=i._(n("b698f887")),c=i._(n("eadc61b0"));let p=(0,r.createStyles)(({css:e,token:t},{alertVisible:n})=>({main:e`
    display: flex;
